  ...
  previews[activeMenuPage].forEach(elem => {
    ...
    item.innerHTML = `
        ...
        <div class="flex-col gap-10">
          <h3 class="font-title-2">${elem.name}</h3>
          <p class="font-title-2">$ ${elem.price}</p>
        </div>
    `;
        ...
        <div class="flex-col gap-10 modal-window__info">
          ...
          <div class="flex-col gap-10 modal-window__buttons">
            ...
            <div class="flex-row gap-20">
              <button class="modal-button active">s</button>
              <button class="modal-button">m</button>
              <button class="modal-button">l</button>
            </div>
          </div>
          <div class="modal-separator"></div>
          <div class="flex-row modal-window__total">
            <span class="font-title-2">Total:</span>
            <span class="font-title-2">$ ${elem.price}</span>
          </div>
        </div>
    `
    }
